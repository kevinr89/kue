...
exports.configureFactory = function( options, queue ) {
  ...
  if( typeof options.redis === 'string' ) {
    ...
    if( conn_info.protocol === 'rediss:' ) {
      if (!options.redis.options) options.redis.options = {};
      options.redis.options.tls = {
...
exports.createClientFactory = function( options ) {
  ...
  console.log("KUE CONNECTING TO REDIS OPTIONS", options.redis.options)
